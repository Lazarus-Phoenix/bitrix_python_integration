...
Итог: никакой "доисторический PHP" вам не нужен! 🙅‍♂️ Работаете чистым Python'ом с REST API и получаете доступ ко всем данным Битрикс24. Кто сказал, что это сложно? 😎
